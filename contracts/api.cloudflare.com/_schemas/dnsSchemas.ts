...
const cfDNSRecordTypeCommon = v.object({
  ...
  ttl: v.union([v.pipe(v.number(), v.minValue(60), v.maxValue(86400)), v.literal(1)]),
...
export const cfCERTRecord = v.object({
  ...
  data: v.exactOptional(v.object({
    algorithm: v.exactOptional(v.pipe(v.number(), v.minValue(0), v.maxValue(255))),
    certificate: v.exactOptional(v.string()),
    key_tag: v.exactOptional(v.pipe(v.number(), v.minValue(0), v.maxValue(65535))),
...
export const cfDNSKEYRecord = v.object({
  ...
  data: v.exactOptional(v.object({
    flags: v.exactOptional(v.pipe(v.number(), v.minValue(0), v.maxValue(65535))),
    protocol: v.exactOptional(v.pipe(v.number(), v.minValue(0), v.maxValue(255))),
    algorithm: v.exactOptional(v.pipe(v.number(), v.minValue(0), v.maxValue(255))),
...
export const cfDSRecord = v.object({
  ...
  data: v.exactOptional(v.object({
    key_tag: v.exactOptional(v.pipe(v.number(), v.minValue(0), v.maxValue(65535))),
    algorithm: v.exactOptional(v.pipe(v.number(), v.minValue(0), v.maxValue(255))),
    digest_type: v.exactOptional(v.pipe(v.number(), v.minValue(0), v.maxValue(255))),
...
export const cfHTTPSRecord = v.object({
  ...
  data: v.exactOptional(v.object({
    priority: v.exactOptional(v.pipe(v.number(), v.minValue(0), v.maxValue(65535))),
...
export const cfLOCRecord = v.object({
  ...
  data: v.exactOptional(v.looseObject({
    size: v.exactOptional(v.pipe(v.number(), v.minValue(0), v.maxValue(90000000))),
    precision_horz: v.exactOptional(v.pipe(v.number(), v.minValue(0), v.maxValue(90000000))),
    precision_vert: v.exactOptional(v.pipe(v.number(), v.minValue(0), v.maxValue(90000000))),
  }))
})
...
export const cfNAPTRRecord = v.object({
  ...
  data: v.exactOptional(v.object({
    order: v.exactOptional(v.pipe(v.number(), v.minValue(0), v.maxValue(65535))),
    preference: v.exactOptional(v.pipe(v.number(), v.minValue(0), v.maxValue(65535))),
...
export const cfSMIMEARecord = v.object({
  ...
  data: v.exactOptional(v.object({
    ...
    selector: v.exactOptional(v.pipe(v.number(), v.minValue(0), v.maxValue(255))),
    matching_type: v.exactOptional(v.pipe(v.number(), v.minValue(0), v.maxValue(255))),
    certificate: v.exactOptional(v.string()),
  }))
})
...
export const cfSRVRecord = v.object({
  ...
  data: v.exactOptional(v.object({
    priority: v.exactOptional(v.pipe(v.number(), v.minValue(0), v.maxValue(65535))),
    weight: v.exactOptional(v.pipe(v.number(), v.minValue(0), v.maxValue(65535))),
...
export const cfRecordResponse = v.union([
  ...
  v.object({...cfOpenPGPKEYRecord.entries, ...cfDNSRecordResponseCommon.entries}),
