      ...
      return (
        <Card class="flex flex-col gap-4 mx-auto w-125">
          <Toolbar
            ...
            actionsSlotLeft={<NavButton href="/ddns">Back</NavButton>}
          />
    ...
    return (
      <Card class="flex flex-col gap-4 mx-auto w-125">
        <Toolbar
          ...
          actionsSlotLeft={<NavButton href="/ddns">Back to List</NavButton>}
          actionsSlotRight={<NavButton href="/ddns/add">Add Another</NavButton>}
        />
